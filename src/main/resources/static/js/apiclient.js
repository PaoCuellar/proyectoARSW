api = (function () {
    ...
    return {
         getSubastaById: function(subasta_id, callback){
             ...
             $.getJSON("http://localhost:8080/subastas/subasta/" + subasta_id, function (data) {
                callback(data);
            });
         },
         ...
         postSubastaPush: function(subasta_id,user_id,push) {
            $.ajax({
                type: "POST",
                url: "http://localhost:8080/subastas/subasta/push", //"https://subastasdinipa.herokuapp.com/subastas/subasta/push",
                data: JSON.stringify({
